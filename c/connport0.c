...
int main()
{
	...
	sin.sin_addr.s_addr = inet_addr("10.151.11.177");
	sin.sin_port = htons(10292);

	sin2.sin_family = AF_INET;
	sin2.sin_addr.s_addr = inet_addr("10.151.11.177");
...
#if 1
		ret = connect( csk[val], (const struct sockaddr *)&sin2, sizeof(struct sockaddr) );
		if( ret != 0 )
